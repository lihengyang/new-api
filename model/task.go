...
type Task struct {
	...
	TokenId           int                   `json:"-" gorm:"column:token_id;not null;default:0;uniqueIndex:idx_tasks_token_client_request,priority:1"`
	ClientRequestID   *string               `json:"-" gorm:"column:client_request_id;type:varchar(191);uniqueIndex:idx_tasks_token_client_request,priority:2"`
	ClientRequestHash *string               `json:"-" gorm:"column:client_request_hash;type:varchar(128)"`
...
type TaskBillingContext struct {
	...
	BillingFamily         string             `json:"billing_family,omitempty"`          // 提交时 family 快照
